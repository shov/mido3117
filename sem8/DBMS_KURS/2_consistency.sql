...
CREATE OR ALTER TRIGGER TR_books_after_insert_update
    ...
    IF (
           ...
           FROM inserted i
                    ...
                    JOIN bill_kinds bk ON b.bill_kind_id = bk.id AND bk.name = N'room_rent'
           WHERE i.approved = 1
             ...
             WHERE gk.name IN (N'registered_by', N'responsible') AND bk.name = N'room_rent' AND i.approved = 1)
        BEGIN
