...
export class GameController {
    ...
    public static create(scene: IGameScene): (canvas: HTMLCanvasElement) => Promise<void> {
    ...
    protected async _initCanvas(canvas: HTMLCanvasElement) {
    ...
    protected _renderDebugInfo(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, dt: number, delta: number, fps: number) {
        ...
        ctx.fillText(`${JSON.stringify(Dimensions.get(''))}`, 20, vOffset + 60)
    }
}
